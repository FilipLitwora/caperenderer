...
function reloadSkin() {
  ...
  if (url === "") {
    ...
    skinViewer
      .loadSkin(url, document.getElementById("skin_model").value)
...
function initializeControls() {
  ...
  document
    .getElementById("global_animation_speed")
    .addEventListener(
      "change",
      (e) => (skinViewer.animations.speed = e.target.value)
    );
  //document
  //.getElementById("aniation_pause_resume")
  //.addEventListener(
  //"click",
  ...
  document
    ...
    .addEventListener("change", (e) => {
      if (e.target.checked && rotateAnimation === null) {
        ...
        rotateAnimation.speed = document.getElementById(
  ...
  document
    .getElementById("rotate_animation_speed")
    .addEventListener("change", (e) => {
  ...
  for (const el of document.querySelectorAll(
    'input[type="radio"][name="primary_animation"]'
  )) {
    el.addEventListener("change", (e) => {
      ...
      if (e.target.value !== "") {
        primaryAnimation = skinViewer.animations.add(
          availableAnimations[e.target.value]
        );
        primaryAnimation.speed = document.getElementById(
          "primary_animation_speed"
        ).value;
      }
    });
  }
  document
    .getElementById("primary_animation_speed")
    .addEventListener("change", (e) => {
      if (primaryAnimation !== null) {
  ...
  document
    ...
    .addEventListener(
      "change",
      (e) => (orbitControl.enableRotate = e.target.checked)
    );
  document
    .getElementById("control_zoom")
    .addEventListener(
      "change",
      (e) => (orbitControl.enableZoom = e.target.checked)
    );
  document
    .getElementById("control_pan")
    .addEventListener(
      "change",
      (e) => (orbitControl.enablePan = e.target.checked)
    );
...
function initializeViewer() {
  ...
  skinViewer.animations.speed = document.getElementById(
  ...
  const primaryAnimationName = document.querySelector(
    'input[type="radio"][name="primary_animation"]:checked'
  ).value;
  if (primaryAnimationName !== "") {
    primaryAnimation = skinViewer.animations.add(
      availableAnimations[primaryAnimationName]
    );
    primaryAnimation.speed = document.getElementById(
      "primary_animation_speed"
    ).value;
